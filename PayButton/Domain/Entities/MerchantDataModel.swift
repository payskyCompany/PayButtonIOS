...
struct MerchantDataModel {
    ...
    init(merchantId: String, terminalId: String, amount: Double, currencyCode: Int, secureHashKey: String,
         trnxRefNumber: String, customerId: String, customerMobile: String, customerEmail: String) {
